...
2. Read `lab/lab-design/meeting-report-prompt.md` for the report format and rules.
3. Read `lab/lab-design/lab-N/iteration-M/meeting-transcripts/transcript-by-speaker.txt` (substituting actual N and M).
4. Following the rules and structure from the prompt file, write the meeting report to `lab/lab-design/lab-N/iteration-M/meeting-report.md`.
